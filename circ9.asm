...
aplic	Proc	Near
		...
		mov dl,0ffh	
		int 21h
		cmp al,'Z'	;presiona Z para aumentar
        je gam3
		jmp gam4
gam3:	inc hvarial+2	
		cmp hvarial+2,3Ah
		je gam5
		jmp gam6
gam5:	mov hvarial+2,30h
		inc hvarial+1
gam6:						;incrementa variable para aumentar la velocidad
gam4:	cmp al,'Q'	;presiona Q para salir
		je rocket
		jmp met12
rocket:	jmp final
met12:	ret
